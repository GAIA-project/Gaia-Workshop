...
Photoresitor = 1
grovepi.pinMode(Photoresitor, "INPUT")
...
def main():
	init()
	while (True):
		value = grovepi.analogRead(Photoresitor)
    		value=value*5/1024
   		if value<4:
        		light=50*value/(5-value)
    		else:
        		light=200       
    		print "Phoresitor Value:",light,"level      Photodiode Value:", readVisibleLux(), "Lux"
		sleep(1)
