...
def main():
    ...
    while not exitapp:
        ...
        if idx_changed or school_data[school_idx][6]:
            ...
            school_data[school_idx] = [ school_data[school_idx][0],
                                        school_data[school_idx][1],
                                        school_data[school_idx][2],
                                        school_data[school_idx][3],
                                        school_data[school_idx][4],
                                        school_data[school_idx][5], False ]
